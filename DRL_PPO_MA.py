...
class ActorCritic(nn.Module):
    ...
    def update_train(self):
        ...
        returns = self.calculate_returns(self.rewards, self.discount_factor)
...
def train(env, policy):
    ...
    for i_ag in range(n_agentes):
        ...
        policy_loss[i_ag], value_loss[i_ag] = policy[i_ag].update_train()
...
if __name__ == "__main__":
    ...
    for dim in HIDDEN_DIM:
        ...
        for episode in range(1, MAX_EPISODES+1):
            ...
            policy_loss, value_loss, train_reward, perc_prod_train = train(train_env, policy)
