...
#import SkilledOperatorRouter
from Skill import SkilledRouter
...
class Machine(CoreObject):
    ...
    def __init__(self, id, name, capacity=1, processingTime=None,
                  ...
                  priority=0,min_proprocessingTime = 0.001,
                  **kw):
        ...
        self.minProssTime = min_proprocessingTime
        self.meanProssTime = processingTime['Normal'].get('mean', None)
    ...
    def Set_processingTime(self,processingTime):
        processingTime=self.getOperationTime(time=processingTime)
        #     Sets the attributes of the processing time(s)
        self.rng=RandomNumberGenerator(self, processingTime)
        ...
        if methods:
            ...
            if methodsRequired:
                for methodTup in methodsRequired:
                    ...
                    objMethod=getMethodFromName('Machine.'+method)
...
#                 self.timeLastProcessingStarted=self.timeLastOperationStarted
    ...
    def Get_Status(self,totalSimTime = -1):
        ...
        status = { self.name:{
                   ...
                   "bp": self.totalBlockageTime/totalSimTime,
                   "wt": self.totalWaitingTime/totalSimTime,
